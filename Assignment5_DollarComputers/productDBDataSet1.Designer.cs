...
namespace Assignment5_DollarComputers.productDBDataSet1TableAdapters {
...
SELECT productID, cost, manufacturer, model, RAM_type, RAM_size, displaytype, screensize, resolution, CPU_Class, CPU_brand, CPU_type, CPU_speed, CPU_number, condition, OS, platform, HDD_size, HDD_speed, GPU_Type, optical_drive, Audio_type, LAN, WIFI, width, height, depth, weight, moust_type, power, webcam FROM products WHERE (productID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Assignment5_DollarComputers.Properties.Settings.Default.productDBConnectionString;
        }
        ...
        public virtual int Fill(productDBDataSet1.productsDataTable dataTable) {
        ...
        public virtual productDBDataSet1.productsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            productDBDataSet1.productsDataTable dataTable = new productDBDataSet1.productsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(productDBDataSet1.productsDataTable dataTable) {
